<header>
    <div class="topbar d-flex align-items-center">
        <nav class="navbar navbar-expand">
            ...
            <div class="search-bar flex-grow-1">
                <div class="position-relative search-bar-box">
                    @if (isset($common_data->title))
                        <h5 class="card-title">{{ $common_data->title }}</h5>
                    @endif
            ...
            <div class="position-relative search-bar-box">
                <input type="hidden" id="tosterMessage" value="{{ Session::get('success') }}">
            ...
            <div class="user-box dropdown">
                <a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#"
                    ...
                    <i style="font-size:31px;color: #18b48c;" class="fadeIn animated bx bx-user-circle"></i>
