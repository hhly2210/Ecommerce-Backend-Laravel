                                    ...
                                    <tbody>
                                        <tr>
                                            <td valign="top" align="center" width="100"
                                                ...
                                                {{-- <img alt="{{ $company_info_share->name }}"
                                ...
                                <table align="center" cellspacing="0" cellpadding="6" width="95%"
                                        ...
                                        @foreach ($details['data']->sellDetail as $product)
                                            <tr width="100%">
                                                ...
                                                <td width="20%"
                                                    ...
                                                    <span> {{ $sub = $product->total_payable_amount }}</span>
                                                </td>
                                            </tr>
                                            <?php $subtotal += $sub; ?>
                                        @endforeach
                                    ...
                                    <tfoot>
                                        ...
                                        <tr>
                                            ...
                                            <td
                                                style="text-align:right;vertical-align:middle;border-left:1px solid #eee;border-bottom:1px solid #eee;border-right:1px solid #eee;border-top:0">
                                                <span>{{ $shipping = $details['data']->shipping_cost }}</span>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td
                                                ...
                                                <span>{{ $details['data']->total_payable_amount + $shipping }}</span>
                                            </td>
                                        </tr>
                                    </tfoot>
                                </table>
                                            ...
                                            <td valign="top">
                                                ...
                                                <p style="margin:0;margin-bottom:10px;padding:0;">
                                                    <strong>Email:</strong> <a href="mailto:remuleo@gmail.com"
                                                        target="_blank">{{ $details['data']->orderAddress->email }}</a>
                                                </p>
                                                <p style="margin:0;margin-bottom:10px;padding:0;">
                                                    <strong>Tel:</strong>
                                                    {{ $details['data']->orderAddress->shipping_phone }}
                                                </p>
                                            </td>
                                        </tr>
                                    </tbody>
                                        ...
                                        <tr>
                                            <td valign="top" style="text-transform:capitalize">
                                                <p style="font-size:12px;line-height:130%">Please call
                                                    {{-- <b> {{ $company_info_share->phone }}</b> in case of any doubts or --}}
                                                    questions.
                                                    Please reply back to email in case of any issues with prices,
                                                    packing charges,
                                                    taxes and other menus issues.
                                                </p>
                                            </td>
                                        </tr>
                                    </tbody>
